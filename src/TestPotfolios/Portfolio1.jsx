  ...
  return (
    ...
    <div className=' bg-cyan-900 '>
      <div className=''>
        ...
        <div>
          <h1 className='text-3xl font-bold text-center text-white p-3'>Services</h1>
        </div>
        <div className='grid gap-6 p-5 lg:grid-cols-4 md:grid-cols-2 '>



          <div className=' shadow-lg rounded-lg flex flex-col bg-cyan-950 border  border-gray-500
              text-gray-300'>
            <div className='h-[150px] flex justify-center items-center bg-cyan-950'>
        ...
        <div className=' '>
          ...
          <div className=' '>
            ...
            ><span className='text-gray-200 font-bold'>Front-end : </span>I have a strong command of front-end technologies like
              <span className=' text-gray-200 font-medium '> Html, Css , React Js , NextJs ,Tailwind ,bootstrap </span></h2>
            <h2 className='px-5 py-2 bg-cyan-950 text-gray-300 rounded-lg md:rounded-lg  text-xl mx-5 m-2 '
            ><span className='text-gray-200 font-bold'>Back-end : </span>
              ...
              <span className=' text-gray-200 font-medium '> Node.js & ExpressJs and MongoDB ,SQL,Firebase  </span>
            </h2>
            <h2 className='px-5 py-2 bg-cyan-950 text-gray-300 rounded-lg md:rounded-lg  text-xl mx-5 m-2 '
            ><span className='text-gray-200 font-bold'>Programing Languages : </span> JavaScript ,TypeScript , Java ,C ,C++ ,kotlin
            </h2>
          </div>
        </div>
        ...
        <div className=' bg-cyan-950 rounded-lg m-4 p-4 text-gray-100'>
          <h1 className='p-2 text-center text-2xl font-bold '> Somme other Skills & Certifications </h1>
          <p className=' text-gray-200'><span className='text-xl font-bold'>Languages : </span>Arabic ,Frensh ,English </p>
          <p className=' text-gray-200'><span className='text-xl font-bold'>Dogree : </span>I have Computer Sciense dogree</p>
